...
export default function Home() {
  ...
  return <main className="min-h-screen bg-[#f5f7fb] pb-24 text-slate-800"><div className="mx-auto max-w-5xl px-4 py-5 sm:px-6">
    <header className="mb-6 flex items-center justify-between"><div><div className="flex items-center gap-2"><span className="grid h-9 w-9 place-items-center rounded-xl bg-[#102a43] text-lg">◈</span><span className="font-bold tracking-tight text-[#102a43]">ContaFácil <b className="text-emerald-600">Pro</b></span></div><p className="mt-2 text-xs text-slate-500">Demostración · Información ficticia</p></div><div className="flex items-center gap-2"><a href="/contador" className="text-xs font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 px-3 py-1.5 rounded-lg border border-emerald-200 transition">📊 Dashboard Contador</a><button className="grid h-10 w-10 place-items-center rounded-full bg-white text-slate-600 shadow-sm" aria-label="Notificaciones">🔔</button></div></header>
